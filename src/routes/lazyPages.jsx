...
export const AdminChannels = lazy(() => import('../pages/admin/AdminChannels'))
export const AdminCommissions = lazy(() => import('../pages/admin/AdminCommissions'))
...
export const PartnerLogin = lazy(() => import('../pages/partners/PartnerLogin'))
export const PartnerDashboard = lazy(() => import('../pages/partners/PartnerDashboard'))
