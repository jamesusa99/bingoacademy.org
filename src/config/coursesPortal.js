...
export const COURSES_PORTAL = {
  ...
  promoCodePlaceholder: 'BINGO2026',
  promoCodeApply: 'Apply',
  promoCodeApplying: 'Checking…',
  promoCodeRemove: 'Remove',
  promoCodeHint: 'Codes from Bingo Academy marketing — applied before Stripe. Order total cannot go below $1.00 after discount.',
  promoCodeMinCheckoutApplied: 'Total adjusted to the $1.00 minimum after discount.',
  promoCodeApplied: (code, label) => `${code} applied — ${label}`,
