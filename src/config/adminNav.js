...
export const ADMIN_DASHBOARD_CARDS = [
  ...
  { labelKey: 'dashboard.cards.mall', statKey: 'mall', to: '/admin/mall/courses', icon: '🛒', color: 'bg-orange-50 border-orange-200/60' },
...
export const ADMIN_DASHBOARD_QUICK_LINKS = [
  ...
  { labelKey: 'nav.mallHub', to: '/admin/mall/courses', className: 'px-4 py-2 rounded-xl bg-cyan-100 text-cyan-800 text-sm font-medium' },
