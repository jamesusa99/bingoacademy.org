...
const messages = {
  zh: {
    ...
    nav: {
      ...
      homePortal: '首页门户',
      courses: 'Lab和材料管理',
      ioaiExperiments: 'IOAI · 公共实验库',
      ioaiHub: 'IOAI',
      ioaiCurriculum: '课程管理',
      ioaiCourseBundles: '套餐管理',
      generalHub: 'Foundations',
      generalCurriculum: '课程管理',
      generalCourseBundles: '套餐管理',
      k12Hub: 'K12',
      k12Curriculum: '课程管理',
      k12CourseBundles: '套餐管理',
      achievements: '学员成果',
      aiCamp: 'AI 营地',
      events: '赛事活动',
      instructors: '导师库',
      ...
      charity: '荣誉公益',
      forum: '论坛',
      community: 'Community 内容',
      communityHub: 'AI 社区',
      communityHome: 'Community Home',
      communityForum: 'AI-Spark Forum',
      communityScholars: 'AI Star Scholars',
      communityCourses: 'Certified Courses',
      communityMentors: 'Elite Mentor Hub',
      communityPartners: 'Certified Partner Institutions',
      communityCheckin: 'Check-In & Points',
      mallHub: 'AI商城',
      mallHome: 'Mall Home',
      mallIoai: 'IOAI · Training',
      mallGeneral: 'Foundations of AI',
      mallK12: 'K12 · School',
      mallCert: 'Certification',
      mallMaterials: 'Books & Kits',
      mallLab: 'Online Labs',
      mallCourses: '课程',
    ...
    video: {
      ...
      classifyHeading: '设置视频分类',
      classifyHint: '选择阶段 → 类别 → 模块，保存后视频会出现在对应分组中（无需重新上传）。',
      saveClassification: '保存分类',
      classifying: '保存中…',
      infoClassifySuccess: '分类已保存，视频已移入对应课程路径。',
      errClassifyIncomplete: '请至少选择或填写阶段信息。',
    },
    ...adminPagesZh,
  },
  en: {
    ...
    nav: {
      ...
      ioaiExperiments: 'IOAI · Experiment library',
      ioaiHub: 'IOAI',
      ioaiCurriculum: 'Courses',
      ioaiCourseBundles: 'Course Bundles',
      generalHub: 'Foundations',
      generalCurriculum: 'Courses',
      generalCourseBundles: 'Course Bundles',
      k12Hub: 'K12',
      k12Curriculum: 'Courses',
      k12CourseBundles: 'Course Bundles',
    ...
    video: {
      ...
      assignLessonOptional: 'Assign to lesson (optional)',
      ...
      classifyHeading: 'Set video classification',
      classifyHint: 'Pick Stage → Category → Module and save — the video moves into that group without re-uploading.',
      saveClassification: 'Save classification',
      classifying: 'Saving…',
      infoClassifySuccess: 'Classification saved. Video is now grouped under the selected path.',
      errClassifyIncomplete: 'Select or enter at least a stage for classification.',
    },
    ...adminPagesEn,
  },
}
