...
export const LAB_EXPERIMENTS_PORTAL = {
  ...
  prevStep: 'Previous',
  nextStep: 'Next',
  openInstructionsHint: 'Open “Instructions” in the toolbar (top right) for overview, purpose, and step-by-step guidance.',
  instructionsDrawerHint: 'The workspace stays active while you read instructions.',
  stepsPanelHint: 'Follow these steps while working in the workspace. The experiment area is not reset when you open this panel.',
